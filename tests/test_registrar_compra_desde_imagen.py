...
@patch("controllers.compras_controller.receipt_parser.parse_receipt_image")
@pytest.mark.parametrize("producto_id", [None, ""])
...
def test_flujo_selecciona_subconjunto_items(
    ...
    try:
        ...
        mock_actualizar.assert_has_calls([call(cafe_id, 1), call(azucar_id, 2)], any_order=True)
